...
<main>
                ...
                <div class="col-lg-6">
                    <div class="tp-contact-wrapper">
                        <div class="tp-contact-title-wrapper">
                            ...
                            <p>
                                Email, call, or complete the form to learn how Kion can <br />
                      ...
                      <span>
                        <svg width="72" height="72" viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg">
                          ...
                          />
                                ...
                                <h3 class="tp-contact-item-title"><a href="mailto:@themepure.gmail.com">info@pmn.org.pk</a></h3>
                            </div>
                      ...
                      <span>
                        <svg width="55" height="55" viewBox="0 0 55 55" fill="none" xmlns="http://www.w3.org/2000/svg">
                          ...
                          />
                                ...
                                <h3 class="tp-contact-item-title"><a href="tel:9266688000">+92 51 215 01 73 – 78</a></h3>
                            </div>
                            <div class="tp-contact-location-wrapper d-flex">
                                <div class="tp-contact-location">
                                    <h3 class="tp-contact-location-title">
                                        Office Location <i class="fa-regular fa-arrow-down"></i>
                                    </h3>
                                    <p>1st floor, 85-East, Kamran Centre, Jinnah Avenue, Blue Area, Islamabad, Pakistan</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="tp-contact-map-area">
        <div class="tp-contact-map">
            <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3318.708827567245!2d73.06700627660356!3d33.716482535383406!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x38dfbf997f61b945%3A0x8a136f14f8aba45c!2sKamran%20Centre!5e0!3m2!1sen!2s!4v1716875450535!5m2!1sen!2s"
                width="600"
                height="450"
                style="border: 0"
                allowfullscreen=""
